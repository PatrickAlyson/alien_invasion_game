...
class AlienInvasion:
	...
	def _create_difficulty_buttons(self):
		...
		self.easy_button = ButtonDiff(self, "Easy", (center[0], center[1]-2*self.normal_button.height))
		self.hard_button = ButtonDiff(self, "Hard", (center[0], center[1]+2*self.normal_button.height))
