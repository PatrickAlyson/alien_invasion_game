"""
 This the main script of the game
"""
...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        # Make the difficulty selection buttons
    ...
    def _check_events(self):
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                if not self.stats.difficulty_flag:
    ...
    def _check_play_button(self, mouse_pos):
        ...
        if button_clicked and not self.stats.game_active:
            ...
            # self._start_game()
            self.stats.difficulty_flag = True
    ...
    def _create_difficulty_buttons(self):
        ...
        self.normal_button = ButtonDiff(self, "Normal", center)
        self.easy_button = ButtonDiff(
            self, "Easy", (center[0], center[1]-2*self.normal_button.height))
        self.hard_button = ButtonDiff(
            self, "Hard", (center[0], center[1]+2*self.normal_button.height))
    ...
    def _check_difficulty_buttons(self, mouse_pos):
        ...
        if not self.stats.game_active:
            if button_clicked_easy:
                self.settings.initialize_dynamic_settings(mode='easy')
                self._start_game()
                self.stats.difficulty_flag = False
            elif button_clicked_normal:
                self.settings.initialize_dynamic_settings(mode='normal')
                self._start_game()
                self.stats.difficulty_flag = False
            elif button_clicked_hard:
                self.settings.initialize_dynamic_settings(mode='hard')
                self._start_game()
                self.stats.difficulty_flag = False
